    ...
    var shark, sharkImg, dieSharkImg;
    ...
    obstacleImg=loadImage("sharkEnemy.png");
    dieSharkImg=loadImage("dieShark.png");
  ...
  background.velocityX=-4;
    ...
    if (keyDown("DOWN_ARROW")) {
      ...
      if(obstacleGroup.isTouching(shark)){
        text("Game Over",300,300);
        shark.velocityX=0;
          shark.velocityY=0;
          shark.addImage(dieSharkImg);
          shark.velocityY=7;
     }   
    ...
    function Obstacles(){
      if(frameCount % 400 === 0){
        obstacle= createSprite(1000,150,40,10);
        obstacle.y = random(200,300); 
        obstacle.velocityX=-13;
        obstacle.addImage(obstacleImg);
        obstacle.scale=0.1;
        obstacle.lifetime = 300;
      shark.depth = obstacle.depth + 1;
        obstacleGroup.add(obstacleImg);
